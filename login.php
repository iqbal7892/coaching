                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="card form-card-22 ml-lg-auto">
                            <div class="card-body">
                                ...
                                <form class="form-login form-22 mt-65">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Email</label>
                                        <input type="email" class="form-control" placeholder="username@gmail.com" id="email" name="email">
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-success btn-round btn-success-shadow pr-20" type="submit">Login
